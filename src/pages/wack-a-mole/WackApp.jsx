...
function WackApp() {
  ...
  function toggleRubberBand(dmole){
    ...
    return (
    <div className="App-wack">
      
      <section className="wackheading">
        <Heading 
          score={score}
      ...
      <section className="wackbody" >

        <div className="wackgrid-container">
          {holesNumber?.map( (mole,idx) => (
            <div 
              key={`hole ${idx}`}
              className="wackgrid-item">
                <div 
                  molenumber = {idx}
                  className="wackfather">
                  <Dirt />
                  <Mole 
                    idx={idx}
                    score={score}
